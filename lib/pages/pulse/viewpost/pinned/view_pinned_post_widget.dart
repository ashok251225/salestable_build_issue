...
import 'view_pinned_post_model.dart';

export 'view_pinned_post_model.dart';

class ViewPinnedPostWidget extends StatefulWidget {
  const ViewPinnedPostWidget(
      {super.key,
  ...
  final ListPinnedElement element;
  @override
  _ViewPinnedPostWidgetState createState() => _ViewPinnedPostWidgetState();
}

class _ViewPinnedPostWidgetState extends State<ViewPinnedPostWidget> {
