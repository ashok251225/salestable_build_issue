...
//
//     final editCheckInResponse = editCheckInResponseFromJson(jsonString);

import 'dart:convert';

EditCheckInResponse editCheckInResponseFromJson(String str) =>
    EditCheckInResponse.fromJson(json.decode(str));

String editCheckInResponseToJson(EditCheckInResponse data) =>
    json.encode(data.toJson());

class EditCheckInResponse {
  final EditCheckData data;
  ...
  factory EditCheckInResponse.fromJson(Map<String, dynamic> json) =>
      EditCheckInResponse(
        data: EditCheckData.fromJson(json["data"] ?? {}),
...
class EditCheckData {
  ...
  factory EditCheckData.fromJson(Map<String, dynamic> json) => EditCheckData(
        date: json["date"] ?? '',
