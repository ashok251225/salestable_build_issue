...
class InProgressCardWidget extends StatefulWidget {
  const InProgressCardWidget({super.key, required this.modulesData});

  final ListElement modulesData;

  @override
  State<InProgressCardWidget> createState() => _InProgressCardWidgetState();
}

class _InProgressCardWidgetState extends State<InProgressCardWidget> {
  ...
  Widget build(BuildContext context) {
    double completedPercentage =
        (widget.modulesData.completedCount / widget.modulesData.totalContents);
