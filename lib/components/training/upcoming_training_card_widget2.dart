...
class UpcomingTrainingCardWidget2 extends StatefulWidget {
  const UpcomingTrainingCardWidget2({super.key, required this.modulesData});
  final RecentModulesData modulesData;

  @override
  State<UpcomingTrainingCardWidget2> createState() =>
      _UpcomingTrainingCardWidgetState();
}

class _UpcomingTrainingCardWidgetState
    extends State<UpcomingTrainingCardWidget2> {
